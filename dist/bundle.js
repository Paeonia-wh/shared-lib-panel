(() => {
  ...
  function preWorkGate(t, isDone) {
    if (isDone) return [];
    const gap = contractGaps(t.contract);
    if (gap.hasGoal && gap.mechanical > 0) return [];
    const out = [];
    out.push("\u2501".repeat(30));
    if (!gap.hasGoal && gap.mechanical === 0) {
      ...
      out.push("    \xB7 \u8FD9\u4EF6\u4E8B\u505A\u6210\u4EC0\u4E48\u6837\u7B97\u5B8C\uFF1F\uFF08\u4E00\u53E5\u8BDD\u7684\u76EE\u6807\uFF09");
      out.push("    \xB7 \u62FF\u4EC0\u4E48\u8BC1\u660E\u5B83\u5B8C\u4E86\uFF1F\uFF08\u6700\u597D\u662F\u673A\u5668\u80FD\u67E5\u7684\uFF1Afile_exists:<\u8DEF\u5F84> / tests_pass:<\u547D\u4EE4>\uFF09");
      ...
      out.push("  \xB7 \u8FD9\u4EF6\u4E8B**\u672C\u6765\u5C31\u80FD\u673A\u5668\u9A8C**\uFF08\u6587\u4EF6\u5728\u4E0D\u5728\u3001\u6D4B\u8BD5\u8FC7\u4E0D\u8FC7\uFF09\u2192 \u5148\u95EE\u7528\u6237\u80FD\u4E0D\u80FD\u52A0\u4E00\u6761\uFF0C");
      out.push("    \u7136\u540E\u7528 project_task_contract \u8865\u4E0A\uFF08\u5F62\u5982 file_exists:<\u8DEF\u5F84> / tests_pass:<\u547D\u4EE4>\uFF09\u3002");
      out.push("  \xB7 \u786E\u5B9E\u53EA\u80FD\u4EBA\u770B\uFF08\u8BBE\u8BA1\u7A3F\u3001\u6587\u6848\uFF09\u2192 \u90A3\u5C31\u662F\u8FD9\u6837\uFF0C\u7EE7\u7EED\u505A\uFF1B");
  ...
  function projBlock(p, t) {
    ...
    if (t) {
      ...
      body2.push(...preWorkGate(t, isDone));
      body2.push(...info);
      body2.push("");
      ...
      body2.push("");
      body2.push("  \uFF08\u60F3\u66F4\u7EC6\u7684\uFF1A\u4ED3\u5E93\u91CC\u7684 docs\\\u63A5\u624B\u4EFB\u52A1.md \u2014\u2014 \u5B8C\u6574\u6D41\u7A0B\u3001\u5224\u636E\u5199\u6CD5\u3001\u5404\u79CD\u8FB9\u754C\u3002");
      body2.push("    \u26A0 \u90A3\u4E2A\u8DEF\u5F84**\u5728\u4F60\u673A\u5668\u4E0A\u4E0D\u4E00\u5B9A\u5B58\u5728**\uFF1B\u6253\u4E0D\u5F00\u5C31\u5FFD\u7565\uFF0C\u4E0A\u9762\u8FD9\u4E9B\u5DF2\u7ECF\u591F\u4F60\u5F00\u5DE5\u3002\uFF09");
      return body2.join("\n");
    }
    const body = [];
  ...
  function splitBlock(p) {
    ...
    if (susp.length) {
      ...
      for (const s of susp) body.push(`    \xB7 ${s.key} \u2014\u2014 ${s.title}\uFF08${s.why}\uFF09`);
    } else {
    ...
    body.push("  \u2461 **\u5148\u786E\u8BA4\u8BA1\u5212\u9501\u6CA1\u9501**\uFF1A");
    body.push("     \xB7 \u6CA1\u9501 \u2192 \u76F4\u63A5 project_task_create(project=\u2026, task_key=\u2026, title=\u2026, \u2026)");
    body.push("     \xB7 \u9501\u7740 \u2192 \u53EA\u80FD project_plan_propose \u63D0\u6848\uFF0C\u800C\u4E14**\u8981\u53E6\u4E00\u4E2A\u4F1A\u8BDD\u6765\u6279**\uFF08\u4E0D\u80FD\u81EA\u6279\uFF09");
    body.push("  \u2462 \u5EFA\u5361\u65F6\u628A**\u9A8C\u6536\u6807\u51C6\u5199\u6210\u5224\u636E**\uFF0C\u5199\u5177\u4F53\u8DEF\u5F84/\u547D\u4EE4\uFF0C\u522B\u5199\u7A7A\u8BDD\uFF1A");
    body.push("       file_exists:src/xxx.ts  \xB7  tests_pass:npm test  \xB7  grep_present:<\u6587\u4EF6>:<\u5173\u952E\u5B57>");
...
<div class="note">
  ...
  async function exportProjectPdf(projKey, btn) {
    ...
    try {
      ...
      const dir = await invoke("resolve_export_dir", { projKey });
