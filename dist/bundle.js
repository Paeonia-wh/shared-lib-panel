(() => {
  ...
  function projBlock(p, t) {
    ...
    if (t) {
      ...
      body2.push(isDone ? `\u3010\u5DF2\u5B8C\u6210 \xB7 ${p.name} / ${t.key}\u3011` : `\u3010\u7EE7\u7EED\u505A \xB7 ${p.name} / ${t.key}\u3011`);
      body2.push(...info);
      body2.push("");
  ...
  function discipline() {
    return [
      "",
      "  \u51E0\u6761\u7EAA\u5F8B\uFF1A",
      "    \xB7 \u2605\u2605 **\u6CA1\u505A\u5B8C\u7684\u4EFB\u52A1\uFF0C\u7EDD\u5BF9\u4E0D\u8981\u6807 done\u3002** \u8FD9\u662F\u6700\u5BB9\u6613\u72AF\u3001\u540E\u679C\u6700\u91CD\u7684\u4E00\u6761\uFF1A",
      ...
      "        \xB7 \u8FD8\u8981\u63A5\u7740\u505A       \u2192 \u7559 pending",
      '        \xB7 \u5361\u5728\u5916\u90E8\u539F\u56E0     \u2192 status="blocked"',
      '        \xB7 \u5E72\u5B8C\u4E86\u7B49\u522B\u4EBA\u9A8C   \u2192 status="review"',
  ...
  function splitBlock(p) {
    ...
    body.push('     \xB7 \u8981\u5199\u4EE3\u7801/\u8981\u505A\u529F\u80FD \u2192 \u62C6\u6210\u82E5\u5E72\u4EFB\u52A1\uFF0C\u6BCF\u4E2A\u5199\u6E05"\u8981\u4EA4\u4EC0\u4E48"\uFF08\u9A8C\u6536\u6807\u51C6\uFF09\u3002');
    body.push("     \xB7 \u7EAF\u8D44\u6599/\u7EAF\u8BB0\u5F55\u7C7B \u2192 \u4E0D\u7528\u62C6\uFF0C\u628A\u8D44\u6599\u7ED3\u6784\u548C\u6765\u6E90\u6574\u7406\u8FDB\u77E5\u8BC6\u56FE\u8C31\u5C31\u884C\uFF0C\u522B\u786C\u9020\u4EFB\u52A1\u3002");
    ...
    body.push("     \xB7 \u8FD9\u5757\u6D3B**\u8FD8\u5728\u67D0\u4E2A\u5DF2\u6709\u4EFB\u52A1\u7684\u5408\u540C\u8303\u56F4\u5185**\uFF08acceptance / constraints \u91CC\u5C31\u5199\u7740\uFF09");
  ...
  var NEW_PROJECT_START = [
    ...
    ``,
    `  \u26A0 \u4E09\u4E2A\u6700\u5BB9\u6613\u72AF\u7684\uFF1A`,
    `     \xB7 tasks \u7559\u7A7A \u2192 \u76F4\u63A5\u62A5\u9519\uFF0C\u5EFA\u4E0D\u51FA\u6765\uFF08\u81F3\u5C11\u5199\u4E00\u4E2A\uFF09`,
    `     \xB7 \u4E0D\u7ED9 root_path \u2192 \u4EE5\u540E\u6309\u76EE\u5F55\u8BA4\u4E0D\u51FA\u8FD9\u4E2A\u9879\u76EE`,
    `     \xB7 \u9A8C\u6536\u6807\u51C6\u5199\u6210\u6563\u6587 \u2192 \u5E73\u53F0\u62E6\u4E0D\u4F4F\u5047 done\uFF0C\u7B49\u4E8E\u8FD9\u6761\u95E8\u7981\u5BF9\u4F60\u65E0\u6548`
  ].join("\n");
