(() => {
  ...
  var PREDICATE_RE = /^(file_exists|grep_absent|grep_present|tests_pass|command_ok|json_has|http_ok):/i;
  function contractGaps(raw) {
  ...
  function projBlock(p, t) {
    ...
    if (t) {
      ...
      if (!isDone) {
        ...
        if (!gap.hasGoal && gap.mechanical === 0) {
          body2.push("\u26A0 **\u5148\u522B\u52A8\u624B \u2014\u2014 \u8FD9\u4E2A\u4EFB\u52A1\u7684\u8981\u6C42\u8FD8\u6CA1\u5B9A\u6E05\u695A\u3002**");
          body2.push('  \u73B0\u5728\u5408\u540C\u91CC\u65E2\u6CA1\u6709"\u76EE\u6807"\uFF0C\u4E5F\u6CA1\u6709\u4E00\u6761\u53EF\u5224\u5B9A\u7684\u9A8C\u6536\u5224\u636E\u3002');
          body2.push("  \u4F60\u8981\u505A\u7684\u7B2C\u4E00\u4EF6\u4E8B\u662F**\u8DDF\u7528\u6237\u628A\u8FD9\u4E24\u6837\u95EE\u6E05\u695A**\uFF1A");
          body2.push("    \xB7 \u8FD9\u4EF6\u4E8B\u505A\u6210\u4EC0\u4E48\u6837\u7B97\u5B8C\uFF1F\uFF08\u4E00\u53E5\u8BDD\u7684\u76EE\u6807\uFF09");
          body2.push("    \xB7 \u62FF\u4EC0\u4E48\u8BC1\u660E\u5B83\u5B8C\u4E86\uFF1F\uFF08\u6700\u597D\u662F\u673A\u5668\u80FD\u67E5\u7684\uFF0C\u6BD4\u5982 file_exists:<\u8DEF\u5F84> / tests_pass:<\u547D\u4EE4>\uFF09");
          body2.push("  \u5B9A\u4E0B\u6765\u4E4B\u540E\uFF1A\u7528 project_task_contract \u628A\u5408\u540C\u8865\u4E0A\uFF0C\u518D\u5F00\u5DE5\u3002");
          body2.push('  \u26A0 \u522B\u81EA\u5DF1\u7F16\u4E00\u4E2A\u6807\u51C6\u5C31\u95F7\u5934\u505A \u2014\u2014 \u90A3\u7B49\u4E8E\u628A"\u505A\u5B8C\u4E86"\u7684\u5B9A\u4E49\u4EA4\u7ED9\u4F60\u81EA\u5DF1\uFF0C');
          body2.push('    \u540E\u9762\u6CA1\u4EBA\u80FD\u9A8C\u6536\uFF08\u5BF9\u8D26\u65F6\u4F1A\u53D8\u6210"\u8BFB\u4E00\u904D\u8BF4\u901A\u8FC7"\uFF09\u3002');
        } else if (gap.mechanical === 0) {
          body2.push("\u26A0 **\u52A8\u624B\u524D\u5148\u786E\u8BA4\u9A8C\u6536\u6807\u51C6**\uFF1A\u5408\u540C\u91CC\u6709\u76EE\u6807\uFF0C\u4F46**\u6CA1\u6709\u4E00\u6761\u673A\u5668\u80FD\u67E5\u7684\u5224\u636E**\u3002");
          body2.push('  \u73B0\u5728\u7684\u9A8C\u6536\u53EA\u80FD\u9760\u4EBA\u8BFB\u4E00\u904D \u2014\u2014 \u800C"\u8BFB\u4E00\u904D"\u6700\u5BB9\u6613\u6F0F\u3002');
          body2.push("  \xB7 \u5982\u679C\u8FD9\u4EF6\u4E8B**\u672C\u6765\u5C31\u80FD\u673A\u5668\u9A8C**\uFF08\u6587\u4EF6\u5728\u4E0D\u5728\u3001\u6D4B\u8BD5\u8FC7\u4E0D\u8FC7\uFF09\u2192 \u5148\u95EE\u7528\u6237\u80FD\u4E0D\u80FD\u52A0\u4E00\u6761");
          body2.push("    \uFF08\u5F62\u5982 file_exists:<\u8DEF\u5F84> / tests_pass:<\u547D\u4EE4>\uFF09\uFF0C\u7136\u540E\u7528 project_task_contract \u8865\u4E0A\u3002");
          body2.push("  \xB7 \u5982\u679C\u786E\u5B9E\u53EA\u80FD\u4EBA\u770B\uFF08\u8BBE\u8BA1\u7A3F\u3001\u6587\u6848\uFF09\u2192 \u90A3\u5C31\u662F\u8FD9\u6837\uFF0C\u7EE7\u7EED\u505A\uFF0C");
          body2.push('    \u4F46\u6536\u5C3E\u65F6\u628A"\u4EBA\u8BE5\u770B\u4EC0\u4E48"\u5199\u8FDB\u68C0\u67E5\u70B9\uFF0C\u522B\u53EA\u8BF4"\u505A\u5B8C\u4E86"\u3002');
        }
      }
      if (t.status === "blocked") {
      ...
      if (isDone) {
        ...
        body2.push("  \u26A0 **\u4F46\u6709\u4E0A\u9650**\uFF1A\u540C\u4E00\u5F20\u5361\u91CD\u5F00\u5230\u7B2C 3 \u6B21\uFF0C\u5E73\u53F0\u4F1A\u81EA\u52A8\u628A\u5B83\u6807\u6210 `blocked`");
        body2.push('     \uFF08\u53CD\u590D\u91CD\u5F00 = \u8FD9\u6D3B\u5E72\u4E0D\u4E0B\u53BB\uFF0C\u4E0D\u662F\u5728"\u518D\u8BD5\u4E00\u904D"\uFF09\u3002\u770B\u5230\u5B83\u53D8 blocked\uFF0C');
        body2.push('     \u4E0D\u662F\u5931\u8D25 \u2014\u2014 \u662F"\u8BE5\u4EBA\u6765\u5B9A\u600E\u4E48\u8D70\u4E86"\uFF0C\u53BB\u95EE\u7528\u6237\uFF0C\u522B\u518D\u91CD\u5F00\u7B2C\u56DB\u904D\u3002');
      ...
      body2.push("");
      body2.push("\u2605 \u5148\u505A\u7684\u4E8B\uFF1A");
      body2.push(`  project_task_dispatch(project="${p.key}", task_key="${t.key}")`);
      body2.push("     \u26A0 \u5B83\u8FD4\u56DE\u7684 **id\uFF0832 \u4F4D uuid\uFF09\u624D\u662F\u540E\u9762\u6240\u6709\u5DE5\u5177\u8981\u7684 task_id** \u2014\u2014 \u4E0D\u662F\u4E0A\u9762\u90A3\u4E2A key\u3002");
      body2.push("     \u7136\u540E project_context_pack(project=\u2026, task_id=<\u90A3\u4E2A id>) \u8BFB\u4E0A\u4E0B\u6587\u3002");
      body2.push("");
      body2.push("  \u26A0 \u4E24\u6761\u6700\u5BB9\u6613\u8E29\u7684\uFF08**\u8FD9\u4E24\u6761\u8FD9\u91CC\u5C31\u8BF4\u5168\u4E86\uFF0C\u4E0D\u7528\u53BB\u770B\u522B\u5904**\uFF09\uFF1A");
      body2.push("     \xB7 \u2605 **\u6CA1\u505A\u5B8C\u7684\u7EDD\u5BF9\u4E0D\u8981\u6807 done** \u2014\u2014 \u5E73\u53F0\u4F1A\u6309\u5408\u540C\u91CC\u7684\u5224\u636E\u62E6\uFF08\u62E6\u4E0B\u6765\u5C31\u91CD\u6765\u4E00\u6B21\uFF09\u3002");
      body2.push('       \u5DF2\u7ECF\u9519\u6807\u4E86\u8981\u9000\u56DE\uFF1Aproject_task_reopen(task_id=<id>, reason="<\u4E3A\u4EC0\u4E48>")\u3002');
      body2.push("     \xB7 \u6536\u5C3E\u987A\u5E8F\u522B\u6362\uFF1A**\u68C0\u67E5\u70B9\u4E94\u9879 \u2192 \u53D1\u4EA7\u51FA \u2192 preflight \u9A8C\u5224\u636E \u2192 \u6807 done**\u3002");
      body2.push("       \u4EA7\u51FA\u8981\u53D1\u771F\u5B9E\u5B58\u5728\u7684\u6587\u4EF6\uFF08\u53EA\u62A5\u8DEF\u5F84\u4E0D\u843D\u5730\uFF0C\u5BF9\u8D26\u4F1A\u5224 rejected\uFF09\u3002");
      body2.push("");
      body2.push("  \uFF08\u60F3\u66F4\u7EC6\u7684\uFF1AD:\\codex-memory\\docs\\\u63A5\u624B\u4EFB\u52A1.md \u2014\u2014 \u5B8C\u6574\u6D41\u7A0B\u3001\u5224\u636E\u5199\u6CD5\u3001\u5404\u79CD\u8FB9\u754C\u3002");
      body2.push("    \u90A3\u662F\u6807\u51C6\u5B89\u88C5\u4F4D\u7F6E\uFF1B**\u6253\u4E0D\u5F00\u5C31\u5FFD\u7565\u5B83\uFF0C\u4E0D\u5F71\u54CD\u4F60\u6309\u4E0A\u9762\u505A**\u3002\uFF09");
      return body2.join("\n");
    }
    const body = [];
    body.push(`\u3010\u9879\u76EE\u73B0\u72B6 \xB7 ${p.name}\uFF08${p.key}\uFF09\u3011`);
    body.push(...info);
    body.push("");
    ...
    body.push("      \xB7 \u6709\u300C\u88AB\u5361\u4F4F\u300D\u7684\u4EFB\u52A1\u65F6\uFF0C\u5148\u95EE\u4ED6\u5361\u4F4F\u7684\u90A3\u4EF6\u4E8B\u6709\u6CA1\u6709\u53D8\u5316\uFF08\u5E38\u5E38\u9700\u8981\u4ED6\u53BB\u63A8\u52A8\u5916\u90E8\uFF09");
    body.push("      \xB7 \u6709\u300C\u5F85\u9A8C\u6536\u300D\u7684\u4EFB\u52A1\u65F6\uFF0C\u95EE\u4ED6\u6709\u6CA1\u6709\u53E6\u4E00\u4E2A\u4F1A\u8BDD\u6765\u5BF9\u8D26\uFF08\u5BF9\u8D26\u4EBA\u4E0D\u80FD\u662F\u4EFB\u52A1\u6240\u6709\u8005\uFF09");
    body.push("   \u2463 \u7528\u6237\u5B9A\u4E86\u4E4B\u540E\uFF0C\u53BB\u70B9**\u90A3\u5F20\u4EFB\u52A1\u5361**\u4E0A\u7684\u300C\u590D\u5236\u63A5\u7EED\u5757\u300D\u2014\u2014");
    body.push("      \u90A3\u4E00\u4EFD\u624D\u5E26\u8FD9\u4E2A\u4EFB\u52A1\u7684\u5408\u540C\uFF08\u8981\u6C42\uFF09\u548C\u68C0\u67E5\u70B9\uFF08\u522B\u4EBA\u8E29\u8FC7\u7684\u5751\uFF09\uFF0C\u662F\u771F\u6B63\u80FD\u5F00\u5DE5\u7684\u6307\u4EE4\u3002");
    body.push("");
    body.push("  \u26A0 \u4E3A\u4EC0\u4E48\u4E0D\u8BA9\u4F60\u76F4\u63A5\u5F00\u5DE5\uFF1A");
    body.push("    \xB7 \u8FD9\u4EFD\u7B80\u62A5**\u6CA1\u6709\u67D0\u4E2A\u4EFB\u52A1\u7684\u8981\u6C42**\uFF08\u5408\u540C\u3001\u9A8C\u6536\u5224\u636E\u3001\u522B\u4EBA\u7559\u4E0B\u7684\u5751\u90FD\u5728\u4EFB\u52A1\u7EA7\u90A3\u4EFD\u91CC\uFF09");
    body.push("    \xB7 \u5148\u5E72\u54EA\u4E2A\u662F**\u7528\u6237\u7684\u51B3\u5B9A**\uFF0C\u4E0D\u662F\u63A5\u7EED\u4F1A\u8BDD\u8BE5\u66FF\u4ED6\u505A\u7684");
  ...
  function projInfo(p) {
    ...
    return scope ? [`\u9879\u76EE\uFF1A${scope}`, ...repoLine(p)] : [
  ...
  function splitBlock(p) {
    ...
    body.push("");
    body.push(hasTasks ? `\u8FD9\u4E2A\u9879\u76EE\u73B0\u5728\u6709 ${p.total} \u4E2A\u4EFB\u52A1\uFF08\u5DF2\u5B8C\u6210 ${p.done}\uFF09\u3002\u4F60\u8981\u5F80\u91CC**\u52A0\u65B0\u4EFB\u52A1**\u3002` : "\u8FD9\u4E2A\u9879\u76EE\u4E00\u4E2A\u4EFB\u52A1\u90FD\u8FD8\u6CA1\u6709\u3002\u4F60\u8981\u628A\u5B83**\u62C6\u6210\u4EFB\u52A1**\u3002");
    body.push("");
    body.push('\u2605 \u505A\u6CD5\u5728\u8FD9\u4EFD\u8BF4\u660E\u91CC\uFF08\u542B"\u5148\u5224\u65AD\u8BE5\u4E0D\u8BE5\u5EFA\u5361""\u8BA1\u5212\u9501\u7740\u600E\u4E48\u8D70\u63D0\u6848"\u7B49\u5B8C\u6574\u6B65\u9AA4\uFF09\uFF1A');
    body.push("     D:\\codex-memory\\docs\\\u52A0\u65B0\u4EFB\u52A1.md");
    body.push("");
    body.push("  \u26A0 \u51E0\u4E2A\u5BB9\u6613\u8E29\u7684\u5148\u63D0\u9192\uFF08\u7EC6\u8282\u5728\u6587\u6863\u91CC\uFF09\uFF1A");
    body.push("     \xB7 \u2605 **\u5148\u5224\u65AD\u8FD9\u5757\u6D3B\u8BE5\u4E0D\u8BE5\u5EFA\u5361** \u2014\u2014 \u8FD8\u5728\u5DF2\u6709\u4EFB\u52A1\u5408\u540C\u8303\u56F4\u5185\u7684\uFF0C\u522B\u5EFA\u65B0\u5361\u3002");
    body.push("     \xB7 \u2605 **\u5148\u786E\u8BA4\u8BA1\u5212\u9501\u6CA1\u9501**\uFF1A\u6CA1\u9501\u76F4\u63A5 project_task_create\uFF1B");
    body.push("       \u9501\u7740\u53EA\u80FD project_plan_propose \u63D0\u6848\uFF0C\u4E14**\u8981\u53E6\u4E00\u4E2A\u4F1A\u8BDD\u6765\u6279**\uFF08\u4E0D\u80FD\u81EA\u6279\uFF09\u3002");
    body.push("     \xB7 \u5EFA\u5361\u65F6\u628A**\u9A8C\u6536\u6807\u51C6\u5199\u6210\u5224\u636E**\uFF08file_exists: / tests_pass: \u2026 \u5199\u5177\u4F53\u8DEF\u5F84/\u547D\u4EE4\uFF09\u3002");
    body.push("     \xB7 \u5EFA\u5B8C\u4E4B\u540E\uFF1A**\u6CA1\u505A\u5B8C\u7684\u5361\u7EDD\u5BF9\u4E0D\u8981\u6807 done**\u3002");
    body.push("");
  ...
  var NEW_PROJECT_START = [
    ...
    `     \xB7 \u8C08\u9700\u6C42\u8D70 \`grill-me\` skill\uFF08\u6BCF\u6B21\u53EA\u95EE 1~2 \u4E2A\uFF0C\u95EE\u5B8C\u590D\u8FF0\u786E\u8BA4\uFF09\u3002`,
    `     \xB7 \u8981"\u62C6\u4EFB\u52A1"\u7C7B\uFF1A**\u5148\u62C6\u597D\u7ED9\u7528\u6237\u770B\uFF0C\u4ED6\u786E\u8BA4\u4E86\u624D\u843D\u5361**\u3002`,
    `     \xB7 \u7528\u6237\u53EA\u8BF4"\u804A\u804A"\uFF1A\u90A3\u5C31\u7EAF\u8BA8\u8BBA\uFF0C**\u4E0D\u843D\u5E93\u3001\u4E0D\u5EFA\u4EFB\u4F55\u4E1C\u897F**\u3002`,
    ``,
