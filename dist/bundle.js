(() => {
  ...
  function projBlock(p, t) {
    ...
    if (t) {
      ...
      body2.push("");
      body2.push("");
      body2.push("\u2605 \u600E\u4E48\u505A\u8FD9\u4EF6\u4E8B\uFF08\u9886\u6D3B \u2192 \u8BFB\u4E0A\u4E0B\u6587 \u2192 \u6536\u5C3E\uFF09\u5728\u8FD9\u4EFD\u8BF4\u660E\u91CC\uFF1A");
      body2.push("     D:\\codex-memory\\docs\\\u63A5\u624B\u4EFB\u52A1.md");
      body2.push("");
      body2.push(`  \u5148\u505A\u7684\u4E8B\uFF1Aproject_task_dispatch(project="${p.key}", task_key="${t.key}")`);
      body2.push("     \u26A0 \u5B83\u8FD4\u56DE\u7684 **id\uFF0832 \u4F4D uuid\uFF09\u624D\u662F\u540E\u9762\u6240\u6709\u5DE5\u5177\u8981\u7684 task_id** \u2014\u2014 \u4E0D\u662F\u4E0A\u9762\u90A3\u4E2A key\u3002");
      body2.push("     \u540E\u9762\u63A5 project_context_pack(project=\u2026, task_id=<\u90A3\u4E2A id>) \u8BFB\u4E0A\u4E0B\u6587\u3002");
      body2.push("");
      body2.push("  \u26A0 \u4E24\u6761\u6700\u5BB9\u6613\u8E29\u7684\uFF08\u7EC6\u8282\u5728\u6587\u6863\u91CC\uFF09\uFF1A");
      body2.push("     \xB7 \u2605 **\u6CA1\u505A\u5B8C\u7684\u7EDD\u5BF9\u4E0D\u8981\u6807 done**\uFF08\u5E73\u53F0\u4F1A\u6309\u5224\u636E\u62E6\uFF0C\u6539\u4E86\u8981 project_task_reopen\uFF09\u3002");
